...
public:
    ...
    bool encryptFolder(
        ...
        QString outputFilePathForFolder =
            QDir(outputFolderPath).filePath(QString("%1%2").arg(namefileExport).arg(folderEncryptExt));
    ...
    bool decryptFolder(
        ...
        for (auto data : deserializedList) {
            ...
            QFile fileData(
                QDir(outputFolderPath).filePath(QString::fromStdString(decryptData.namefile).chopped(4)));
