...
enum State { NEWSTATE, DELSTATE, CHANGEDS, UNRECOGS };
...
namespace Resolver {
enum Lifetime { SHORT = 0, LONG = 1 };
enum Type { BLOCKCHAIN = 0, ACTORS = 1, DFS = 2, GENERAL = 3 };
}  // namespace Resolver
...
const QString MESSAGE_PATTERN =
    "[%{time h:mm:ss.zzz}][%{function}][%{type}]: %{message}";
...
static const std::string chatIdStorage =
    "CREATE TABLE IF NOT EXISTS " + chatIdTableName +
    " ("
...
static const std::string chatUserStorage =
    "CREATE TABLE IF NOT EXISTS " + chatUserTableName +
    " ("
    "userId  TEXT  PRIMARY KEY NOT NULL);";

static const std::string chatMessageTableName = "Chat";
static const std::string sessionChatMessageStorage =
    "CREATE TABLE IF NOT EXISTS " + chatMessageTableName +
    " ("
...
static const std::string storedTableCreation =
    "CREATE TABLE IF NOT EXISTS " + storedTableName +
    " ("
...
static const std::string tableFollowerCreation =
    "CREATE TABLE IF NOT EXISTS " + subscribeFollowerTableName +
    " ("
    "subscriber    TEXT PRIMARY KEY NOT NULL,"
    "sign TEXT             NOT NULL)";
static const std::string subscribeColumnTableName = "Subscriptions";
static const std::string tableMySubscribeCreation =
    "CREATE TABLE IF NOT EXISTS " + subscribeColumnTableName +
    " ("
    "subscription    TEXT PRIMARY KEY NOT NULL);";

static const std::string chatInviteTableName = "Invite";
static const std::string chatInviteCreation =
    "CREATE TABLE IF NOT EXISTS " + chatInviteTableName +
    " ("
    "chatId  TEXT PRIMARY KEY NOT NULL, "
    "message BLOB             NOT NULL, "
    "owner   TEXT             NOT NULL  );";
...
static const std::string postPropertiesTableCreation =
    "CREATE TABLE IF NOT EXISTS " + propertiesTableName + propertiesFields +
    "sign         TEXT     NOT NULL"
    ");";

static const std::string userListPropertiesTableCreation =
    "CREATE TABLE IF NOT EXISTS " + usersSubscribedOnEventTable +
    userListSubscribedTablepropertiesFields + ";";

static const std::string eventPropertiesTableCreation =
    "CREATE TABLE IF NOT EXISTS " + propertiesTableName + propertiesFields +
...
static const std::string textTableCreation =
...
static const std::string attachTableCreation =
    "CREATE TABLE IF NOT EXISTS " + attachTableName +
    " ("
...
static const std::string commentsTableCreation =
...
static const std::string likesTableCreation =
    "CREATE TABLE IF NOT EXISTS " + likesTableName +
    " ("
    "liker TEXT PRIMARY KEY NOT NULL,"
    "sign  TEXT            NOT NULL);";

static const std::string savedPostsTableCreation =
    "CREATE TABLE IF NOT EXISTS " + savedPostsTableName +
    " ("
    "user TEXT NOT NULL,"
    "post TEXT NOT NULL,"
    "PRIMARY KEY (user, post)"
    ");";
static const std::string savedEventsTableCreation =
    "CREATE TABLE IF NOT EXISTS " + savedEventsTableName +
    " ("
    "user TEXT NOT NULL,"
    "event TEXT NOT NULL,"
...
static const std::string usersFollowersTableCreation =
    "CREATE TABLE IF NOT EXISTS " + usersFollowersTableName +
    " ("
    "userId TEXT PRIMARY KEY NOT NULL,"
    "sign  TEXT            NOT NULL);";
static const std::string usersConfirmedTableCreation =
    "CREATE TABLE IF NOT EXISTS " + usersConfirmedTableName +
    " ("
    "userId TEXT PRIMARY KEY NOT NULL,"
    "sign  TEXT            NOT NULL);";
static const std::string usersMarkedTableCreation =
    "CREATE TABLE IF NOT EXISTS " + usersMarkedTableName +
    " ("
    "userId TEXT PRIMARY KEY NOT NULL,"
    "sign  TEXT            NOT NULL);";

static const std::string BlockTable = "Block";
static const std::string BlockTableCreate = "CREATE TABLE IF NOT EXISTS " +
                                            BlockTable +
                                            " ( "
                                            "type         TEXT  NOT NULL, "
                                            "id           TEXT  NOT NULL, "
...
static const std::string TxBlockTableCreate = "CREATE TABLE IF NOT EXISTS " +
                                              TxBlockTable +
                                              " ("
                                              "sender       TEXT  NOT NULL, "
...
static const std::string SignBlockTableCreate =
    "CREATE TABLE IF NOT EXISTS " + SignTable +
    " ("
...
static const std::string GenesisBlockTableCreate =
    "CREATE TABLE IF NOT EXISTS " + GenesisBlockTable +
    " ("
    "type         TEXT  NOT NULL, "
    "id           TEXT  NOT NULL, "
    "date         TEXT  NOT NULL, "
...
static const std::string RowGenesisBlockTableCreate =
    "CREATE TABLE IF NOT EXISTS " + RowGenesisBlockTable +
    " ("
...
static const std::string tokensCacheTableCreate =
    "CREATE TABLE IF NOT EXISTS " + tokensCacheTable +
    " ("
...
enum TypeSend { ALL, EXCEPT, FOCUSED };
}  // namespace Net
}  // namespace Config
...
static const QByteArray INFORMATION_SEPARATOR_ONE =
    "\u0001E\u0001F\u0001C\u0001E";
static const QByteArray INFORMATION_SEPARATOR_TWO =
    "\u0001C\u0001F\u0001E\u0001C";  // used in network
static const QByteArray INFORMATION_SEPARATOR_THREE =
    "\u0001E\u0001F\u000C\u0001F";
...
QByteArray universalSerialize(const QList<QByteArray> &list,
                              const int &fiels_size = DEFAULT_FIELD_SIZE);
QList<QByteArray> universalDeserialize(
    const QByteArray &serialized, const int &fiels_size = DEFAULT_FIELD_SIZE);
}  // namespace Serialization
...
enum typeDataRow { UNIVERSAL, STAKING };
}  // namespace DataStorage
...
enum class BlockParam { Id = 0, Approver, Data, Hash, Null };
...
static BlockParam fromStringBlockParam(QByteArray s) {
  if (s == "Id") return BlockParam::Id;
  if (s == "Approver") return BlockParam::Approver;
  if (s == "Data") return BlockParam::Data;
  if (s == "Hash") return BlockParam::Hash;
...
static TxParam fromStringTxParam(QByteArray s) {
  if (s == "User") return TxParam::User;
  if (s == "UserApprover") return TxParam::UserApprover;
  if (s == "UserReceiver") return TxParam::UserReceiver;
  if (s == "UserSender") return TxParam::UserSender;
  if (s == "UserSenderOrReceiver") return TxParam::UserSenderOrReceiver;
  if (s == "Hash") return TxParam::Hash;
  return TxParam::Null;
}
}  // namespace SearchEnum
