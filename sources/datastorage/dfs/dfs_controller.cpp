...
std::string DfsController::addLocalFile(const Actor<KeyPrivate> &actor, const std::filesystem::path &filePath,
    ...
    DFS::Permission::AddPermission addpermission = { .actor = actor.id().toStdString(),
                                                     .path = newTargetVirtualFilePath,
...
void DfsController::removeLocalFile(const Actor<KeyPrivate> &actor, const std::string &filePath) {
    ...
    PermissionManager permissionManager(&node);
    DFS::Permission::RemovePermission rmPermission = { .actor = actor.id().toStdString(),
                                                       .fileHash = fileHash };
...
void DfsController::updatePermissions(const std::vector<DFS::Permission::UpdatePermission> &permissions) {
    ...
    for (const auto &permission : permissions) {
        ...
        case DFS::Permission::Action::AddAction: {
            DFS::Permission::AddPermission newPermission = { .actor = permission.actor,
        ...
        case DFS::Permission::Action::RemoveAction: {
            DFS::Permission::RemovePermission rmPermission = { .actor = permission.actor,
                                                               .fileHash = permission.fileHash };
            permissionManager.remove(rmPermission);
            break;
        }
