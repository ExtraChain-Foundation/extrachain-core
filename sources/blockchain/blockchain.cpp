...
void Blockchain::syncResponse(const BigNumber fromBlock, const std::string &identifier) {
    auto lastBlock = getLastBlock();
...
void Blockchain::addBlockNetwork(const BlockVariant &block, const std::string &identifier) {
